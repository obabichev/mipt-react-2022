...
fun fetchData(): List<Good>  {
    val testData = arrayListOf<Good>()
    testData.add(Good("f2f5e7ea-edf8-42c2-96bb-d31d81e67092",
    ...
    testData.add(Good("0a54bedf-8c7e-41d6-8ef1-31aab08dbb36",
...
val GoodsList = FC<Props> {
    val mainScope = MainScope()
    var currentProduct: Good? by useState(null)
    var unselectedProducts: List<Good> by useState(emptyList())
    var selectedProducts: List<Good> by useState(emptyList())

    useEffectOnce {
        mainScope.launch {
            unselectedProducts = fetchData()
        }
    }
    ...
    div {
        ...
        ProductList {
            products = unselectedProducts + selectedProducts
